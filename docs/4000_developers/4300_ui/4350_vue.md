...
Each vue component extends the base [EvanComponent](https://github.com/evannetwork/ui-dapps/blob/master/core/evancore.vue.libs/src/component.ts), that adds evan.network specific runtime variables to the vue component instance like the following ones:
...
### Formulars
The framework also includes the [EvanForm](https://github.com/evannetwork/ui-dapps/blob/master/core/evancore.vue.libs/src/forms.ts) class. Simply define your evan form instance and all the parameters you want to edit and it will handle validity checks and error handling. A sample is also included within the `dispatcher.ts`.
