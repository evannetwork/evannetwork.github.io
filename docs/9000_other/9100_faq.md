...
#### A.
A Smart Contract based [Proof Of Authority](/docs/developers/concepts/blockchain.html) consensus is used. [AuthorityNode](/docs/how_it_works/authoritynode.html) operators (Affiliates) are added to the group of authorities (DAO). Only these are able to sign new blocks.
