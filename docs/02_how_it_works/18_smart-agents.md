...
![Smart Agent](./img/smart_agent.png){:width="100px"}
...
- **onboarding** Smart Agent<br>
  ...
  The onboarding Smart Agent acts as the entity that brings new users into evan.network. It takes care of creating the user profile and infrastructure. It also handles invitations from users already in evan.network and a bridge between users, who already have an evan.network account and people they wish to invite. The agent takes care of sending them notifications and transferring starting-[EVE](/docs/04_developers/blockchain.html#eve---token)s to allow the new users to start working.<br>
...
To learn how to create Smart Agents, take a look at our [tutorial example](/docs/04_developers/hello-agent.html).
