...
#### [Decentralized Identities](/docs/how_it_works/identity.html)
...
#### [Smart Contract Access Delegation (SCAD)](/docs/developers/permissioning.html)
...
#### [Packaged DApps](/docs/developers/ui/basics.html)
...
#### [Customized Namespaces](/docs/how_it_works/namespaces.html)
...
#### [Contract Templates](/docs/developers/tooling/deployment.html)
...
<dl>
<dt><a href="/docs/first_steps/quick-start.html">Quick Start</a><dt>
...
<dt><a href="/docs/whats_evan/goals.html">General Overview</a></dt>
<dd>A deeper look into the concepts of the <a href="/docs/whats_evan/network.html">network</a> and the DAO.</dd>
<dt><a href="/docs/how_it_works/technical_overview.html">Technical Details</a></dt>
<dd> Dive deeper and immerse yourself.</dd>
<dt><a href="/docs/developers.html">Start Programming</a></dt>
...
<dt><a href="/docs/other/faq.html">FAQ</a></dt>
<dd> </dd>
<dt><a href="/docs/other/glossary.html">Glossary</a></dt>
<dd> </dd>
...
<svg id="evan.network" version="1.1" width="100%" viewBox="0 0 600 900" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g transform="translate(-20, -40)">
    <g id="edge-server" transform="translate(20, 50)">
      ...
      <a xlink:href="/docs/how_it_works/smart-agents.html">
    ...
    <g id="core-dapps" transform="translate(200, 50)">
      <title>ÐApps</title>
      <a xlink:href="/docs/developers/ui/writing-dapps.html">
        <rect class="bw dotted" x="30" width="160" height="140" />
    ...
    <g id="applications" transform="translate(380, 50)">
      ...
      <a xlink:href="/docs/developers.html">
        <rect class="bw dotted" x="30" width="160" height="140" />
  ...
  <g id="core-api" transform="translate(10, 180)">
    ...
    <a xlink:href="/docs/developers/permissioning.html#key-exchange" transform="translate(20,20)">
    ...
    <a xlink:href="/docs/developers/api/blockchain-core.html" transform="translate(200,20)">
      <rect class="library" width="160" height="80" rx="2"/>
      <text class="white" x="32" y="42">Blockchain Core</text>
      <title>ECMAScript Library to work with Ethereum Contracts and IPFS</title>
    </a>

    <a xlink:href="/docs/developers/concepts/dbcp.html" transform="translate(380,20)">
      <rect class="library" width="160" height="80" rx="2"/>
  ...
  <g id="core-services" transform="translate(10, 310)">
    ...
    <g transform="translate(0,20)">
      <g transform="translate(70,0)">
        ...
        <a xlink:href="/docs/how_it_works/smart-contracts.html#rights-and-roles" transform="translate(50,20)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">RightsAndRoles</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#mailbox" transform="translate(60,36)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">Mailbox</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#profile" transform="translate(70,52)">
          <rect class="contract" width="130" height="60" rx="2"/>
        ...
        <a xlink:href="/docs/how_it_works/smart-contracts.html#contract-factories" transform="translate(220,20)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">ProfileFactory</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#contract-factories" transform="translate(230,36)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">DigitalTwinFactory</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#contract-factories" transform="translate(240,52)">
          <rect class="contract" width="130" height="60" rx="2"/>
        ...
        <a xlink:href="/docs/how_it_works/smart-contracts.html#service-contract" transform="translate(220,150)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="4" y="12">ServiceContract</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#business-center" transform="translate(230,166)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">BusinessCenter</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#data-contract" transform="translate(240,182)">
          <rect class="contract" width="130" height="60" rx="2"/>
        ...
        <a xlink:href="/docs/how_it_works/smart-contracts.html#ens" transform="translate(50,150)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">ENS</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#event-hub" transform="translate(60,166)">
          <rect class="contract" width="130" height="60" rx="2"/>
          <text class="code" x="2" y="12">EventHub</text>
          <title>Ethereum Contract</title>
        </a>
        <a xlink:href="/docs/how_it_works/smart-contracts.html#base-contract" transform="translate(70,182)">
          <rect class="contract" width="130" height="60" rx="2"/>
  ...
  <g id="core-network" transform="translate(10, 600)">
    ...
    <g transform="translate(40, 0)">
      ...
      <a xlink:href="/docs/how_it_works/authoritynode.html">
        <text x="210" y="60">AuthorityNode</text>
      </a>

      <a xlink:href="/docs/developers/concepts/blockchain.html" transform="translate(60,70)">
      ...
      <a xlink:href="/docs/developers/concepts/ipfs.html" transform="translate(250,70)">
        <rect class="server" width="175" height="80" rx="3"/>
