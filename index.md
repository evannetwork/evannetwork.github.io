...
providing native DApps, an on chain messaging service, an identity solution (Decentralized Identities) for accounts, and an access control for smart contracts, amongst others. 
