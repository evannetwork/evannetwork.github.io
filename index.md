...
providing native DApps, Digital Twins as copies of real life assets, an on chain messaging service, an identity solution (Decentralized Identities) for accounts, and an access control for smart contracts, amongst others. 
