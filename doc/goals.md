...
The evan.network is initiated by [contractus GmbH](www.contractus.com) and gradually transferred to a decentralized autonomous organization (DAO) by the admission of partners into the evan.network, in which the control of the network is carried out by the involved partners themselves.
