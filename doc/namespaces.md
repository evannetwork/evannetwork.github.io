...
Evan.network uses the Ethereum Name Service (ENS) to provide unique namespaces for DApps and identities. With the help of unique namespaces your blockchain applications and identities receive a human-readable address.
