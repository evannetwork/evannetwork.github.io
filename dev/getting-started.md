...
+ contact management with integrated on-chain key management and key exchange through the
+ mailbox system to offer offline invitation and contact possibilities
+ data contracts with security and role management and the ability to add encrypted content and a highly flexible way
