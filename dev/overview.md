...
[The full API documentation](https://github.com/evannetwork/blockchain-core) shows the actual exposed sub-namespaces in the blockchain core module are slightly more fine-grained.
